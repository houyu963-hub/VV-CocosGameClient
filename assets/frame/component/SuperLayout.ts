import { Component, EventHandler, Node, PageViewIndicator, Prefab, Size, UITransform, Vec2, Vec3, _decorator, ccenum, instantiate } from 'cc';
    ...
    protected createItems(count: number, refreshLastItem: boolean = false) {
        ...
        for (let i = 0; i < total; i++) {
            ...
            if (!this.needAddPrefab()) {
                ...
                // vv.logger.log("已固定item数量" + this._maxPrefabTotal)
                break
            }
        }
    }
